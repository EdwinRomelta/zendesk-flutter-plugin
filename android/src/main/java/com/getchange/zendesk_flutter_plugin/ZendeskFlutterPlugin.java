...
public class ZendeskFlutterPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {

    private Handler mainHandler = new Handler(Looper.getMainLooper());
    private ZopimChatApi.DefaultConfig config = null;
    private ChatApi chatApi = null;
    private String applicationId = null;
    private MethodChannel callsChannel = null;
    private FlutterFragmentActivity activity = null;
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        final MethodChannel callsChannel = new MethodChannel(binding.getBinaryMessenger(), "plugins.flutter.zendesk_chat_api/calls");
        final EventChannel connectionStatusEventsChannel = new EventChannel(binding.getBinaryMessenger(), "plugins.flutter.zendesk_chat_api/connection_status_events");
        final EventChannel accountStatusEventsChannel = new EventChannel(binding.getBinaryMessenger(), "plugins.flutter.zendesk_chat_api/account_status_events");
        final EventChannel agentEventsChannel = new EventChannel(binding.getBinaryMessenger(), "plugins.flutter.zendesk_chat_api/agent_events");
        final EventChannel chatItemsEventsChannel = new EventChannel(binding.getBinaryMessenger(), "plugins.flutter.zendesk_chat_api/chat_items_events");

        callsChannel.setMethodCallHandler(this);
        ...
        agentEventsChannel.setStreamHandler(agentsStreamHandler);
        chatItemsEventsChannel.setStreamHandler(chatItemsStreamHandler);
    }
        ...
        switch (call.method) {
            ...
            case "startChat":
                if (config == null || activity == null) {
                    ...
                    chatApi = sessionConfig.build(activity);
                    bindChatListeners();
                    result.success(null);
                }
                break;
